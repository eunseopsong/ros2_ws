...
class BoundingBox2D(metaclass=Metaclass_BoundingBox2D):
    ...
    _fields_and_field_types = {
        'center': 'interfaces_pkg/Point2D',
        'size': 'interfaces_pkg/Point2D',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['interfaces_pkg', 'msg'], 'Point2D'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['interfaces_pkg', 'msg'], 'Point2D'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from interfaces_pkg.msg import Point2D
        self.center = kwargs.get('center', Point2D())
        from interfaces_pkg.msg import Point2D
        self.size = kwargs.get('size', Point2D())
    ...
    def center(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'center' field must be a sub message of type 'Point2D'"
        self._center = value
    ...
    def size(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Point2D), \
                "The 'size' field must be a sub message of type 'Point2D'"
        self._size = value
