    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'interfaces_pkg.msg.DetectionArray')
            logger.debug(
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<interfaces_pkg/Detection>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['interfaces_pkg', 'msg'], 'Detection')),  # noqa: E501
    )
