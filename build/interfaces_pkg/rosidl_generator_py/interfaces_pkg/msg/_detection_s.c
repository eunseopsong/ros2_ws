...
bool interfaces_pkg__msg__bounding_box2_d__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * interfaces_pkg__msg__bounding_box2_d__convert_to_py(void * raw_ros_message);
bool interfaces_pkg__msg__mask__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * interfaces_pkg__msg__mask__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool interfaces_pkg__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces_pkg.msg._detection.Detection", full_classname_dest, 39) == 0);
  }
  interfaces_pkg__msg__Detection * ros_message = _ros_message;
  {  // class_id
  ...
  {  // bbox
    ...
    if (!interfaces_pkg__msg__bounding_box2_d__convert_from_py(field, &ros_message->bbox)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // mask
    ...
    if (!interfaces_pkg__msg__mask__convert_from_py(field, &ros_message->mask)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * interfaces_pkg__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces_pkg.msg._detection");
  ...
  {  // bbox
    PyObject * field = NULL;
    field = interfaces_pkg__msg__bounding_box2_d__convert_to_py(&ros_message->bbox);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // mask
    PyObject * field = NULL;
    field = interfaces_pkg__msg__mask__convert_to_py(&ros_message->mask);
    if (!field) {
      return NULL;
    }
    {
