...
class Mask(metaclass=Metaclass_Mask):
    ...
    _fields_and_field_types = {
        'height': 'int32',
        'width': 'int32',
        'data': 'sequence<interfaces_pkg/Point2D>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int32'),  # noqa: E501
        rosidl_parser.definition.BasicType('int32'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['interfaces_pkg', 'msg'], 'Point2D')),  # noqa: E501
    )
