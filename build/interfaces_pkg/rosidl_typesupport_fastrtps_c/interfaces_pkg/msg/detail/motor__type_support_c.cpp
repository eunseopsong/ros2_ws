...
#include "interfaces_pkg/msg/detail/motor__rosidl_typesupport_fastrtps_c.h"
...
using _Motor__ros_msg_type = interfaces_pkg__msg__Motor;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: front_volt
  {
    cdr << ros_message->front_volt;
  }

  // Field name: rear_volt
  {
...
size_t get_serialized_size_interfaces_pkg__msg__Motor(
  const void * untyped_ros_message,
...
static uint32_t _Motor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces_pkg__msg__Motor(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces_pkg
size_t max_serialized_size_interfaces_pkg__msg__Motor(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_interfaces_pkg__msg__Motor(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_pkg, msg, Motor)() {
