...
#include "interfaces_pkg/msg/detail/point2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Point2D__ros_msg_type = interfaces_pkg__msg__Point2D;
...
static uint32_t _Point2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces_pkg__msg__Point2D(
...
{
  return max_serialized_size_interfaces_pkg__msg__Point2D(
    full_bounded, 0);
}
