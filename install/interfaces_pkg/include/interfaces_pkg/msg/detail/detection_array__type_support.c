...
#include <stddef.h>
#include "interfaces_pkg/msg/detail/detection_array__rosidl_typesupport_introspection_c.h"
...
// Member `detections`
#include "interfaces_pkg/msg/detection.h"
// Member `detections`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  interfaces_pkg__msg__DetectionArray__init(message_memory);
}

void DetectionArray__rosidl_typesupport_introspection_c__DetectionArray_fini_function(void * message_memory)
{
  interfaces_pkg__msg__DetectionArray__fini(message_memory);
}

size_t DetectionArray__rosidl_typesupport_introspection_c__size_function__Detection__detections(
  const void * untyped_member)
{
  const interfaces_pkg__msg__Detection__Sequence * member =
    (const interfaces_pkg__msg__Detection__Sequence *)(untyped_member);
  return member->size;
}
...
{
  interfaces_pkg__msg__Detection__Sequence * member =
    (interfaces_pkg__msg__Detection__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  interfaces_pkg__msg__Detection__Sequence * member =
    (interfaces_pkg__msg__Detection__Sequence *)(untyped_member);
  interfaces_pkg__msg__Detection__Sequence__fini(member);
  return interfaces_pkg__msg__Detection__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember DetectionArray__rosidl_typesupport_introspection_c__DetectionArray_message_member_array[2] = {
  {
    ...
    offsetof(interfaces_pkg__msg__DetectionArray, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces_pkg__msg__DetectionArray, detections),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers DetectionArray__rosidl_typesupport_introspection_c__DetectionArray_message_members = {
  ...
  2,  // number of fields
  sizeof(interfaces_pkg__msg__DetectionArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces_pkg, msg, DetectionArray)() {
