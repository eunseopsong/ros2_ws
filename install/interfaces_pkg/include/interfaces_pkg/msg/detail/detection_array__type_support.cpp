...
{
  new (message_memory) interfaces_pkg::msg::DetectionArray(_init);
}

void DetectionArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces_pkg::msg::DetectionArray *>(message_memory);
  typed_message->~DetectionArray();
}

size_t size_function__DetectionArray__detections(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<interfaces_pkg::msg::Detection> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<interfaces_pkg::msg::Detection> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<interfaces_pkg::msg::Detection> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectionArray_message_member_array[2] = {
  {
    ...
    offsetof(interfaces_pkg::msg::DetectionArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<interfaces_pkg::msg::Detection>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces_pkg::msg::DetectionArray, detections),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DetectionArray_message_members = {
  ...
  2,  // number of fields
  sizeof(interfaces_pkg::msg::DetectionArray),
...
{
  return &::interfaces_pkg::msg::rosidl_typesupport_introspection_cpp::DetectionArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces_pkg, msg, DetectionArray)() {
  return &::interfaces_pkg::msg::rosidl_typesupport_introspection_cpp::DetectionArray_message_type_support_handle;
}
